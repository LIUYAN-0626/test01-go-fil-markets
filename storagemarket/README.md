...
To install:
```bash
go get github.com/LIUYAN-0626/test01-go-fil-markets/storagemarket
```
...
* [GoDoc](https://godoc.org/github.com/LIUYAN-0626/test01-go-fil-markets/storagemarket) contains an architectural overview and robust API documentation
